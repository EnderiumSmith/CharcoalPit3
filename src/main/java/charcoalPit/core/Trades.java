...
public class Trades {
	...
	public static VillagerTrades.ItemListing RandomSapling=new BasicItemListing(12,new ItemStack(ModItemRegistry.RandomSapling),6,1);
	public static VillagerTrades.ItemListing DecorativeSapling=new BasicItemListing(8,new ItemStack(ModItemRegistry.DecorativeSapling),6,1);
	...
	public static void SaplingTrades(WandererTradesEvent event){
		...
		event.getRareTrades().add(RandomSapling);
		event.getRareTrades().add(DecorativeSapling);
	}
