...
public class DistilleryContainer extends AbstractContainerMenu {
	...
	public DistilleryContainer(int id,BlockPos pos,Inventory pInv){
		this(id,pos,pInv,new ItemStackHandler(1),new SimpleContainerData(4));
	}
	
	public DistilleryContainer(int id, BlockPos pos, Inventory pInv, TileDistillery tile){
		this(id, pos, pInv, tile.fuel, new ContainerData() {
			@Override
	...
	public DistilleryContainer(int id, BlockPos pos, Inventory pInv, ItemStackHandler handler, ContainerData data){
		super(ModContainerRegistry.Distillery,id);
		this.pos=pos;
		
		this.addSlot(new SlotItemHandler(handler,0,71,53));
	...
	public boolean stillValid(Player playerIn) {
		return playerIn.level.getBlockState(pos).getBlock() == ModBlockRegistry.Distillery&&
