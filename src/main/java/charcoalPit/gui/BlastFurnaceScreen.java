...
public class BlastFurnaceScreen extends AbstractContainerScreen<BlastFurnaceContainer> {
	...
	private static final ResourceLocation BLAST_GUI_TEXTURES = new ResourceLocation(CharcoalPit.MODID, "textures/gui/container/blast_furnace.png");
	...
	protected void renderBg(PoseStack pPoseStack, float pPartialTick, int pMouseX, int pMouseY) {
		...
		RenderSystem.setShaderTexture(0,BLAST_GUI_TEXTURES);
